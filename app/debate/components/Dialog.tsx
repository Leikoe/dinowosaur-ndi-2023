...
const dialogs: DialogModel[] = [
    ...
    },
    {
        ...
        text: "(Il me semblait avoir des papiers sur ça…)",
        forceAnswer: false,
        canBeAnswered: true,
        answers: [
            {
            ...
            {
                text: "Présenter les Tardigrades et leur résistance",
                continue: 48001,
                weight: -1,
            },
            {
                text: "Présenter le cas des animaux marins.",
                continue: 491,
                weight: 1,
            },
    ...
    },
    {
        ...
        text: "Mais il y a en effet des espèces qui s’adaptent, telles que le Tardigrade qui est un organisme qui est capable de résister à des conditions extrêmes !",
        forceAnswer: false,
        canBeAnswered: true,
        answers: [],
        continue: 48003,
    },
    {
        ...
        text: "Nous n’avons qu’à devenir des Tardigrades alors, est-ce ce que je dois comprendre ?",
        forceAnswer: false,
        canBeAnswered: true,
        answers: [],
        continue: 48004,
    },
    {
        ...
        text: "Eh bien, non, mais nous pouvons prendre exemple sur leurs capacités d’adaptation.",
        forceAnswer: false,
        canBeAnswered: true,
        answers: [],
        continue: 48005,
    },
    {
        ...
        text: "Je ne suis pas bien sûr que ces capacités soient applicables à l’humain…",
        forceAnswer: false,
        canBeAnswered: true,
        answers: [],
        continue: 52,
    ...
    },
    {
        ...
        answers: [
            ...
            {
                text: "Rappeler le début du débat.",
                continue: 57,
                weight: 1,
            },
            {
                text: "Présenter l’exemple des catastrophes naturelles.",
                continue: 57,
                weight: 1,
            },
    ...
    },
    {
        ...
        text: "Comme dit le proverbe, qui ne dit mot consent…",
        forceAnswer: false,
        canBeAnswered: true,
        answers: [],
        continue: -1,
